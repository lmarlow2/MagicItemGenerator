...
var enchantments = [{prefix:[""], suffix:[""], name:[""], effect:[""], addsDamage:false, damageDice:[""], damageType:[""], value:[0]},
		    ...
		    {prefix:["Burning", "Chilled", "Sparking", "Echoing", "Shining", "Rotten", "Toxic", "Caustic", "Dynamic", "Psychal", "Searing", "Cold", "Shocking", "Resounding", "Brilliant", "Decaying", "Venomous", "Astringent", "Cogent", "Cerebral", "Incinerating", "Freezing", "Electrified", "Booming", "Luciferous", "", "Virulent", "Mordant", "Vehement", "Transmundane", "Frostbrand", "Flame Tongue"], suffix:["", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "of Necrosis", "", "", "", ""], name:["Burning", "Chilled", "Sparking", "Echoing", "Shining", "Rotten", "Toxic", "Caustic", "Dynamic", "Psychal", "Searing", "Cold", "Shocking", "Resounding", "Brilliant", "Decaying", "Venomous", "Astringent", "Cogent", "Cerebral", "Incinerating", "Freezing", "Electrified", "Booming", "Luciferous", "Necrosis", "Virulent", "Mordant", "Vehement", "Transmundane", "Frostbrand", "Flame Tongue"], effect:["weapon does an additional 1d4 fire damage.", "weapon does an additional 1d4 cold damage.", "weapon does an additional 1d4 lightning damage.", "weapon does an additional 1d4 thunder damage.", "weapon does an additional 1d4 radiant damage.", "weapon does an additional 1d4 necrotic damage.", "weapon does an additional 1d4 poison damage.", "weapon does an additional 1d4 acid damage.", "weapon does an additional 1d4 force damage.", "weapon does an additional 1d4 psychic damage.", "weapon does an additional 1d6 fire damage.", "weapon does an additional 1d6 cold damage.", "weapon does an additional 1d6 lightning damage.", "weapon does an additional 1d6 thunder damage.", "weapon does an additional 1d6 radiant damage.", "weapon does an additional 1d6 necrotic damage.", "weapon does an additional 1d6 poison damage.", "weapon does an additional 1d6 acid damage.", "weapon does an additional 1d6 force damage.", "weapon does an additional 1d6 psychic damage.", "weapon does an additional 2d6 fire damage.", "weapon does an additional 2d6 cold damage.", "weapon does an additional 2d6 lightning damage.", "weapon does an additional 2d6 thunder damage.", "weapon does an additional 2d6 radiant damage.", "weapon does an additional 2d6 necrotic damage.", "weapon does an additional 2d6 poison damage.", "weapon does an additional 2d6 acid damage.", "weapon does an additional 2d6 force damage.", "weapon does an additional 2d6 psychic damage.", "When you hit with an attack using this magic sword, the target takes an extra 1d6 cold damage. In addition, while you hold the sword, you have resistance to fire damage. In freezing temperatures, the blade sheds bright light in a 10-foot radius and dim light for an additional 10 feet. When you draw this weapon, you can extinguish all non-magical flames within 30 feet of you. This property can be used no more than once per hour.", "You can use a bonus action to speak this magic sword's command word, causing flames to erupt from the blade. These flames shed bright light in a 40-foot radius and dim light for an additional 40 feet. While the sword is ablaze, it deals an extra 2d6 fire damage to any target it hits. The flames last until you use a bonus action to speak the command word again or until you drop or sheathe the sword."], addsDamage:true, damageDice:["1d4", "1d4", "1d4", "1d4", "1d4", "1d4", "1d4", "1d4", "1d4", "1d4", "1d6", "1d6", "1d6", "1d6", "1d6", "1d6", "1d6", "1d6", "1d6", "1d6", "2d6", "2d6", "2d6", "2d6", "2d6", "2d6", "2d6", "2d6", "2d6", "2d6", "1d6", "2d6"], damageType:["Fire", "Cold", "Lightning", "Thunder", "Radiant", "Necrotic", "Poison", "Acid", "Force", "Psychic", "Fire", "Cold", "Lightning", "Thunder", "Radiant", "Necrotic", "Poison", "Acid", "Force", "Psychic", "Fire", "Cold", "Lightning", "Thunder", "Radiant", "Necrotic", "Poison", "Acid", "Force", "Psychic", "Cold", "Fire"], value:[1500, 1500, 1500, 1500, 1500, 1500, 1500, 1500, 1500, 1500, 3000, 3000, 3000, 3000, 3000, 3000, 3000, 3000, 3000, 3000, 7000, 7000, 7000, 7000, 7000, 7000, 7000, 7000, 7000, 7000, 3000, 7000]},
		    ...
		    {prefix:[""], suffix:["of Wounding"], name:["Wounding"], effect:["Hit points lost to this weapon's damage can be regained only through a short or long rest, rather than by regeneration, magic, or any other means. Once per turn, when you hit a creature with an attack using this magic weapon, you can wound the target. At the start of each of the wounded creature's turns, it takes 1d4 necrotic damage for each time you've wounded it, and it can then make a DC 15 Constitution saving throw, ending the effect of all such wounds on itself on a success. Alternatively, the wounded creature, or a creature within 5 feet of it, can use an action to make a DC 15 Wisdom (Medicine) check, ending the effect of such wounds on it on a success."], addsDamage:true, damageDice:["1d4"], damageType:["Necrotic"], value:[2000]},
		    {prefix:[""], suffix:["of Speed"], name:["Speed"], effect:["You gain a +2 bonus to attack and damage rolls made with this magic weapon. In addition, you can make one attack with it as a bonus action on each of your turns. Proficiency with a scimitar allows you to add your proficiency bonus to the attack roll for any attack you make with it."], addsDamage:true, damageDice:["2"], damageType:[""], value:[6000]},
		    {prefix:[""], suffix:["of the Defender"], name:["Defender"], effect:["You gain a +3 bonus to attack and damage rolls made with this magic weapon. The first time you attack with the sword on each of your turns, you can transfer some or all of the sword's bonus to your Armor Class, instead of using the bonus on any attacks that turn. For example, you could reduce the bonus to your attack and damage rolls to +1 and gain a +2 bonus to AC. The adjusted bonuses remain in effect until the start of your next turn, although you must hold the sword to gain a bonus to AC from it."], addsDamage:true, damageDice:["3"], damageType:[""], value:[20000]}
];
